...
urlpatterns = [
    ...
    path('send-exam-notification/<int:exam_id>/',
         views.send_exam_notification_view, name='send-exam-notification'),
    path('resend-notification/<int:notification_id>/',
         views.resend_notification_view, name='resend-notification'),
    ...
    path('upload-student-csv/', views.upload_csv,
         {'entity_type': 'student'}, name='upload_student_csv'),
    path('upload-faculty-csv/', views.upload_csv,
         {'entity_type': 'faculty'}, name='upload_faculty_csv'),
    path('upload-room-csv/', views.upload_csv,
         {'entity_type': 'room'}, name='upload_room_csv'),
]
